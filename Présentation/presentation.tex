...
\begin{frame}{Why Edge Computing?}
  ...
  \end{itemize}
  \note{
     In this video, we'll understand what Edge Computing is, why it's needed, and how it works, with a real-life example. So without further ado, let's get started.
